...
const mytitle = [
  {
    icon: "img/mous-1.webp",
    title: "Redragon K1NG M916 PRO 1K Hz 3-Mode Wireless Gaming Mouse",
  },
  {
    icon: "img/muose-2.webp",
    title: "Redragon PREDATOR M612 PRO Anime Gaming Mouse",
  },
  {
    icon: "img/muose-3.webp",
    title: "Redragon K1NG M918 MAX 1K Hz 3-Mode Wireless Anime Gaming Mouse",
  },
  {
    icon: "img/muose-4.webp",
    title: "Redragon AZZINOTH M921 RGB MMO Gaming Mouse w/18 Programmable Buttons",
  },
  {
    icon: "img/muose-5.webp",
    title: "Redragon M908 IMPACT MMO Gaming Mouse up to 12,400 DPI High Precision Mouse for PC, 18 Programmable Buttons, Weight Tuning Cartridge, 12 Side Buttons, 5 programmable user profiles, 16.8 Million Customizing LED Color Option",
  },
  {
    icon: "img/muose-6.webp",
    title: "Redragon M913 Impact Elite Wireless Gaming Mouse, 16000 DPI Wired/Wireless RGB Gamer Mouse with 16 Programmable Buttons",
  },
  {
    icon: "img/muose-7.webp",
    title: "Redragon K1NG M916 ULT 8K Hz 3-Mode Wireless Gaming Mouse",
  },
  {
    icon: "img/muose-8.webp",
    title: "Redragon M616 TRIDENT RGB 10000 DPI Wired Optical Mouse",
  },
  {
    icon: "img/muose-9.webp",
    title: "Redragon K1NG MAX M918 PRO 1K Hz 3-Mode Wireless Gaming Mouse",
  },
];
...
let mLength = 45; // الحد الأقصى لعدد الحروف
