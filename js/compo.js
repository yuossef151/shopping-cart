const mytitle = [
  {
    icon: "img/compo-1.webp",
    title:
      "EISA K686 PRO SE Keyboard & K1NG M916 PRO (1K Hz) Mouse Anime Combo",
  },
  {
    icon: "img/compo-2.webp",
    title: "Redragon BS8772 Wireless Keyboard and Mouse Combo",
  },
  {
    icon: "img/compo-3.webp",
    title:
      "K628 75% Mechanical Gaming Keyboard M693 Gaming Mouse Tri-Modes Combo",
  },
  {
    icon: "img/compo-4.webp",
    title:
      "Redragon S101-1 Gaming Keyboard Mouse Combo, RGB LED Backlit 104 Keys USB Wired Ergonomic Wrist Rest Keyboard, Programmable 6 Button Mouse for Windows PC Gamer - [Keyboard Mouse Set]",
  },
  {
    icon: "img/compo-5.webp",
    title: "Redragon RYLO S141 Membrane Gaming Keyboard & Mouse Wired Combo",
  },
  {
    icon: "img/compo-6.webp",
    title: "RYLO PRO S142 Membrane Gaming Keyboard & Mouse Tri-Mode Combo",
  },
  {
    icon: "img/compo-7.webp",
    title:
      "Redragon K530 60% RGB Wireless Mechanical Keyboard M808 Lightweight RGB Gaming Mouse Bundle (Black)",
  },
  {
    icon: "img/compo-8.webp",
    title:
      "Redragon K530 60% RGB Wireless Mechanical Keyboard M808 Lightweight RGB Gaming Mouse Bundle",
  },
  {
    icon: "img/compo-9.webp",
    title:
      "Redragon K530 60% RGB Wireless Mechanical Keyboard M808 Lightweight RGB Mouse & H510 Gaming Headset Bundle",
  },
];
